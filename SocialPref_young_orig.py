...
for index,csv_file in enumerate(os.listdir(coordinates_path)):
    ...
    # SC BOX
    x_box1, y_box1 = 400, 480
    x_box2, y_box2 = 525, 480
    x_box3, y_box3 = 525, 680
    x_box4, y_box4 = 400, 680
    ...
    # NSC BOX
    x_box5, y_box5 = 400, 50
    x_box6, y_box6 = 525, 50
    x_box7, y_box7 = 525, 260
    x_box8, y_box8 = 400, 260
