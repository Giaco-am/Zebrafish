...
coordinates_path = r'young_coord_flip'
results_path = r'Young_flip\SocialPref'
...
for index,csv_file in enumerate(os.listdir(coordinates_path)):
    ...
    # SC BOX
    x_box1, y_box1 = 465, 465
    x_box2, y_box2 = 590, 465
    x_box3, y_box3 = 590, 660
    x_box4, y_box4 = 465, 660
    ...
    # NSC BOX
    x_box5, y_box5 = 465, 45
    x_box6, y_box6 = 590, 45
    x_box7, y_box7 = 590, 240
    x_box8, y_box8 = 465, 240
