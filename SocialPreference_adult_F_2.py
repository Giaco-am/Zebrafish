...
csv_file_path = r'coordinates\Adults F iso 2 spDLC_resnet50_social isolationApr3shuffle1_110000.csv'
...
# SC BOX
x_box1, y_box1 = 450, 475
x_box2, y_box2 = 580, 475
x_box3, y_box3 = 580, 670
x_box4, y_box4 = 450, 670
...
# NSC BOX
x_box5, y_box5 = 450, 30
x_box6, y_box6 = 580, 30
x_box7, y_box7 = 580, 230
x_box8, y_box8 = 450, 230
...
class HeadOrientationAnalysis:
    ...
    def save_data(self):
        self.output_folder = 'Adults'
        os.makedirs(self.output_folder, exist_ok=True)

        sub_folder = os.path.join(self.output_folder, 'socialPref', 'F_iso2')
